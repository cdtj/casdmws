...
public class RIPExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^ListResult",RIPListResult.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createObjectResponse",RIPcreateObjectResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createAssetResponse",RIPcreateAssetResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createChangeOrderResponse",RIPcreateChangeOrderResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createIssueResponse",RIPcreateIssueResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createWorkFlowTaskResponse",RIPcreateWorkFlowTaskResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createRequestResponse",RIPcreateRequestResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createTicketResponse",RIPcreateTicketResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^createQuickTicketResponse",RIPcreateQuickTicketResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^getAssetExtensionInformationResponse",RIPgetAssetExtensionInformationResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^getRelatedListValuesResponse",RIPgetRelatedListValuesResponse.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^ArrayOfString",RIPArrayOfString.class);
        classNames.put("http://www.ca.com/UnicenterServicePlus/ServiceDesk^^ArrayOfInt",RIPArrayOfInt.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public RIPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RIPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RIPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RIPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,RIPExtendedSoapSerializationEnvelope.class);
